    ...
    <div class="analise-popup-overlay" id="tipsterDrillOverlay" onclick="closeTipsterDrill(event)">
      <div class="analise-popup-modal" id="tipsterDrillModal" onclick="event.stopPropagation()">
        <div class="analise-popup-hdr" style="gap:12px;align-items:center">
          ...
          <div style="display:flex;align-items:center;background:var(--fdc-steel);border:1.5px solid var(--accent);border-radius:10px;padding:8px 22px;flex-shrink:0"><span id="tipsterDrillName" style="font-size:22px;font-weight:800;letter-spacing:-.02em;color:var(--accent);font-family:var(--font-sans)"></span></div>
