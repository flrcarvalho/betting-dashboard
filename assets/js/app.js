  ...
  <div class="app">
    ...
    <main class="main"><div class="main-content">
      ...
      <div class="page" id="page-tipsters">
        ...
        ${mkCard('tipster_kpi','Tipsters — Visão Geral','<div class="tcard-sort"><span class="tcard-sort__lbl">Ordenar</span><div class="tcard-seg" id="tipsterSeg"><button data-k="pl" class="active" onclick="tipsterSortBy(this.dataset.k)">P/L</button><button data-k="roi" onclick="tipsterSortBy(this.dataset.k)">ROI</button><button data-k="to" onclick="tipsterSortBy(this.dataset.k)">Turnover</button><button data-k="wr" onclick="tipsterSortBy(this.dataset.k)">Win Rate</button><button data-k="vol" onclick="tipsterSortBy(this.dataset.k)">Volume</button></div><button class="tcard-dir" id="tipsterDir" onclick="tipsterSortDir()">↓</button></div><div class="tcard-grid" id="tipsterKpiCards"></div>')}
