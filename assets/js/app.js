    ...
    <div class="analise-popup-overlay" id="tipsterDrillOverlay" onclick="closeTipsterDrill(event)">
      <div class="analise-popup-modal" id="tipsterDrillModal" onclick="event.stopPropagation()">
        <div class="analise-popup-hdr" style="gap:12px;align-items:center">
          <img src="brand/fdc-logo-horizontal-dark.svg" height="98" alt="FDC Capital" class="drill-brand-logo" style="flex-shrink:0;filter:brightness(1.15)" crossorigin="anonymous">
          <span id="tipsterDrillName" class="nametag" style="font-size:24px;font-weight:700;letter-spacing:-.01em;color:var(--accent);font-family:var(--font-sans);flex-shrink:0"></span>
